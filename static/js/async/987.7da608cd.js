    ...
    ["987"], {
        23085: function(e, r, t) {
            ...
            let p = e => {
                ...
                v = e => {
                    ...
                    let {
                        messages: t
                    } = e, [o, n] = s.useState(!1), i = null == t ? void 0 : null === (r = t[0]) || void 0 === r ? void 0 : r.toString();
                    s.useEffect(() => {
                        n(!0)
                    }, []);
                    let a = () => {
            ...
            let N = e => {
                    ...
                    return (0, l.jsx)(y.rU, {
                        className: j()("dc-btn dc-btn--primary", t, "effect", `dc-btn__${n}`),
                        to: s ? ? "",
                        onClick: o,
                        children: r
                    })
                ...
                Z = e => {
                    ...
                    return (0, l.jsxs)("div", {
                        ...
                        children: [!!i && (0, l.jsxs)(l.Fragment, {
                            ...
                            className: j()("dc-page-error__box", {
                            ...
                            children: [(0, l.jsx)(g.Z, {
                                ...
                                className: j()("dc-page-error__message-wrapper", {
                                    "dc-page-error__message-wrapper--left": !!i
                                }),
                                children: (0, l.jsx)(g.Z, {
                                    color: "prominent",
                                    className: j()("dc-page-error__message", {
                                ...
                                children: [x && 0 !== d.length && (null == _ ? void 0 : null === (r = _.map) || void 0 === r ? void 0 : r.call(_, (e, r) => (0, l.jsx)(N, {
            ...
            class R extends s.Component {
                constructor(e) {
                    ...
                    }), (0, n._)(this, "render", () => this.state.hasError ? (0, l.jsx)(H, {
            ...
            let T = (0, o.Pi)(() => {
                let {
                    ...
                    var e;
                    return n && (null == i ? void 0 : null === (e = i[a]) || void 0 === e ? void 0 : e.landing_company_name) === "maltainvest" && !c && t && o !== L.DQA.LOW_RISK_CR_EU && o !== L.DQA.LOW_RISK_CR_NON_EU
                }, [n, c, t, o, i, a]);
                return (0, l.jsxs)(u.Z, {
                    is_open: _ || !1,
                    width: "44rem",
            ...
            var B = t("88199");
            t("674");
            let $ = (0, s.lazy)(() => Promise.all([t.e("361"), t.e("176"), t.e("546"), t.e("702")]).then(t.bind(t, 71118))),
                P = () => (0, l.jsx)(S.Z, {
                    message: (0, d.NC)("Initializing D-Bot...")
                }),
                F = (0, o.Pi)(() => {
                    var e, r, t, s, o, n, i;
                    let {
                    ...
                    return a.error ? (0, l.jsx)(H, {
                        ...
                        should_clear_error_on_click: null === (o = a.error) || void 0 === o ? void 0 : o.should_clear_error_on_click,
                        setError: a.setError,
                        redirect_to: null === (n = a.error) || void 0 === n ? void 0 : n.redirect_to,
                ...
                A = () => {
                    ...
                    return ((0, s.useEffect)(() => {
                        (async () => {
                            !r.current && (await B.api_base.init(), await B.api_base2.customInit(), await B.api_base3.customInit(), await B.api_base4.customInit(), r.current = !0, o(!0))
                        })()
                    }, []), e && t) ? (0, l.jsx)(s.Suspense, {
                        fallback: (0, l.jsx)(P, {}),
                        children: (0, l.jsxs)(R, {
                            root_store: e,
                            children: [(0, l.jsx)(F, {}), (0, l.jsx)($, {}), (0, l.jsx)(T, {})]
                        })
                    }) : (0, l.jsx)(P, {})
                }
        },
        48766: function(e, r, t) {
            ...
            let n = e => {
                ...
                return (0, o.nI)() ? (0, l.jsx)(s.Fragment, {
                    children: r
                }) : null
            }
        },
        ...
        94145: function(e, r, t) {
            ...
            let u = e => {
                let {
                    ...
                    wrapper_classname: j,
                    learn_more_banner: f
                } = e, w = s.useRef(null), [y, N] = s.useState(0);
                s.useLayoutEffect(() => {
                    w.current && !y && N(w.current.offsetHeight)
                }, [t, y]);
                    ...
                    children: (0, l.jsx)("div", {
                        ...
                        children: (0, l.jsxs)(c.Z, {
                            ...
                            children: [(0, l.jsxs)(h.Z, {
                                ...
                                className: x || f ? n()("dc-mobile-dialog__header-wrapper", m) : "",
                                children: [(0, l.jsxs)("div", {
                                    className: n()("dc-mobile-dialog__header", !x && !f && m),
                                    children: [(0, l.jsx)(_.Z, {
                                        as: "h2",
                                        size: "xs",
                                        color: "prominent",
        ...
        66163: function(e, r, t) {
            ...
            let n = e => {
                ...
                return (0, o.tq)() ? (0, l.jsx)(s.Fragment, {
                    children: r
                }) : null
            }
        },
        31784: function(e, r, t) {
            ...
            let u = e => {
                    let {
                        ...
                        toggleModal: I,
                        width: T
                    } = e, B = s.useRef(document.createElement("div")), $ = z && document.getElementById(z), P = s.useRef($ || document.getElementById(z)), F = s.useRef(null), A = [".dc-datepicker__picker", ".dc-mobile-dialog", ".dc-dropdown-list", ".dc-dropdown__list", ".modal_root"], D = () => {
                        var e;
                        return null === (e = P.current) || void 0 === e ? void 0 : e.querySelectorAll(A.join(", ")).length
                    };
                    (0, d.t)(F, () => {
                        j && (null == I || I())
                    }, e => {
                        ...
                        return H || u && !D() && j && !l && !(a && (null == s ? void 0 : s.find(e => a.includes(e))))
                    }), s.useEffect(() => {
                        var e, r;
                    ...
                    return i.createPortal((0, l.jsxs)("div", {
                        ...
                        className: n()("dc-modal__container", {
                            ...
                            "dc-modal__container--is-vertical-centered": N,
        ...
        40150: function(e, r, t) {
            ...
            let a = e => {
                let {
                    ...
                    style: p = {},
                    scroll_height: v,
                    should_scroll_to_selected: b = !1,
                    width: j
                } = e, [f, w] = (0, i.X)(g, !1);
                return (s.useEffect(() => {
                    if (b && v) {
                        var e;
                        null == f || null === (e = f.current) || void 0 === e || e.scrollTo(0, v)
                    }
                }, [v, f, b]), c) ? t : (0, l.jsx)("div", {
                    "data-testid": m,
                    ref: f,
